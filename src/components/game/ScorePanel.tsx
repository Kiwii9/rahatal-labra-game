// ============================
// ScorePanel: Clean score display with glow active state
// ============================
...
const ScorePanel = ({ teamName, score, teamColor, isActive }: ScorePanelProps) => {
  ...
  return (
    <motion.div
      className="rounded-xl p-4 md:p-6 text-center min-w-[130px] md:min-w-[170px] relative overflow-hidden"
      style={{
        background: `linear-gradient(180deg, ${color}15 0%, rgba(26,54,68,0.9) 100%)`,
